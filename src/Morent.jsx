...
function Morent() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("https://morent.ir/").then(
      () => {
        setCopied(true);
  ...
  return (
    <div id="morent">
      <div id="container">
        ...
        <div className="h-screen absolute top-0 left-0 w-full translate-[-100%] green">
          {isDesktop && (
            <video
              className="h-screen w-screen"
              src="https://seyedalinajafi.ir/assets/morent-video-720.mp4"
              type="video/mp4"
              ref={videoRef}
              muted
              autoPlay
          ...
          {isMobile && (
            <video
              className="h-screen w-screen"
              src="https://seyedalinajafi.ir/assets/morent-video-mobile-720.mp4"
              type="video/mp4"
              ref={videoRef}
              muted
              autoPlay
